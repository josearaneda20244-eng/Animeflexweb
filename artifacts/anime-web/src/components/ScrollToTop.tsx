  ...
  return (
    <button
      ...
      onMouseEnter={e => {
        ...
        (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 8px 28px rgba(108,99,255,0.6)";
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLButtonElement).style.transform = "";
        (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 4px 20px rgba(108,99,255,0.45)";
      }}
    >

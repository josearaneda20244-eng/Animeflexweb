  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: "0 4px 20px rgba(124,111,255,0.45)",
        transition: "transform 0.18s, box-shadow 0.18s",
        animation: "fadeInUp 0.25s ease",
      }}
      onMouseEnter={e => {
        (e.currentTarget as HTMLButtonElement).style.transform = "scale(1.12) translateY(-2px)";
        (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 8px 28px rgba(124,111,255,0.6)";
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLButtonElement).style.transform = "";
        (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 4px 20px rgba(124,111,255,0.45)";
      }}
    >

  ...
  return (
    <>
      <nav
        ...
        style={{ background: "rgba(7,8,15,0.75)", backdropFilter: "blur(22px) saturate(1.5)", WebkitBackdropFilter: "blur(22px) saturate(1.5)", borderBottom: "1px solid rgba(124,111,255,0.14)", boxShadow: "0 4px 32px rgba(0,0,0,0.4)" }}
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "0 16px", height: 56 }}>
          ...
          <Link href="/" style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none", flexShrink: 0, marginRight: 8 }}>
            <div style={{ width: 30, height: 30, borderRadius: 9, display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg,#7C6FFF,#5B52F5)" }}>
              ...
              <div ref={searchBoxRef} style={{ flex: 1, position: "relative", display: "flex", alignItems: "center" }}>
                ...
                {showSuggestions && suggestions.length > 0 && (
                  <div style={{
                    ...
                    background: "#0F0F1A", border: "1px solid rgba(124,111,255,0.3)", borderTop: "none",
                        ...
                        <div key={anime.id} onClick={() => handleSuggestionClick(anime)}
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 2 }}>
                              {anime.type && <span style={{ color: "#7C6FFF", fontSize: 10, fontWeight: 700 }}>{anime.type}</span>}
                    ...
                    <div onClick={() => { if (query.trim()) { navigate(`/search?q=${encodeURIComponent(query.trim())}`); setSearchOpen(false); setQuery(""); setSuggestions([]); setShowSuggestions(false); } }}
                      style={{
                        padding: "9px 14px", color: "#7C6FFF", fontSize: 12, fontWeight: 700,
                      ...
                      {[
                        ...
                        <button key={href} onClick={() => { navigate(href); setMoreOpen(false); }}
                          style={{
                            ...
                            background: isActive(href) ? "rgba(124,111,255,0.15)" : "none", border: "none",
                            borderRadius: 10, cursor: "pointer",
                            color: isActive(href) ? "#B39DFF" : "rgba(255,255,255,0.65)", fontSize: 13, fontWeight: 600,
                          }}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    color: "#B39DFF", fontSize: 12, fontWeight: 700, cursor: "pointer",
                  }}
                ...
                {user ? (
                  <div ref={userMenuRef} style={{ position: "relative" }}>
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 10, background: "rgba(124,111,255,0.12)", border: "1px solid rgba(124,111,255,0.25)",
                        cursor: "pointer",
                      }}
                    >
                      <div style={{
                        width: 28, height: 28, borderRadius: 8, background: "linear-gradient(135deg,#7C6FFF,#5B52F5)",
                      ...
                      <span className="hidden md:flex" style={{ color: "#B39DFF", fontSize: 12, fontWeight: 700, maxWidth: 90, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", alignItems: "center", gap: 4 }}>
                        {user.username}
                    ...
                    {showUserMenu && (
                      <div style={{
                        ...
                        border: "1px solid rgba(124,111,255,0.2)", borderRadius: 18,
                        overflow: "hidden", minWidth: 280,
                        boxShadow: "0 24px 60px rgba(0,0,0,0.8), 0 0 0 1px rgba(124,111,255,0.1) inset",
                      }}>
                        {/* Banner + Avatar */}
                        <div style={{ position: "relative", height: 72, background: "linear-gradient(135deg,#2D1B69 0%,#1A1A3E 50%,#0D0D1F 100%)", overflow: "hidden" }}>
                          <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at 20% 50%,rgba(124,111,255,0.35) 0%,transparent 70%)" }} />
                          <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at 80% 50%,rgba(245,158,11,0.12) 0%,transparent 70%)" }} />
                          {/* Decorative dots */}
                          <div style={{ position: "absolute", top: 10, right: 20, width: 40, height: 40, borderRadius: "50%", background: "rgba(124,111,255,0.15)", filter: "blur(8px)" }} />
                        ...
                        <div style={{ padding: "0 16px", marginTop: -28, position: "relative", display: "flex", alignItems: "flex-end", justifyContent: "space-between" }}>
                          ...
                          <div style={{ display: "flex", gap: 4, marginBottom: 4 }}>
                            ...
                            {isMegaFan && (
                              <span style={{
                                display: "inline-flex", alignItems: "center", gap: 3,
                                background: "linear-gradient(135deg,rgba(245,158,11,0.3),rgba(124,111,255,0.2))",
                        ...
                        <div style={{
                          ...
                          {[
                            { label: "Favoritos", value: favorites.length, icon: <Bookmark size={13} color="#B39DFF" />, href: "/favorites" },
                            { label: "Mi Lista", value: watchList.length, icon: <ListVideo size={13} color="#7C6FFF" />, href: "/watchlist" },
                            ...
                            <button key={href} onClick={() => { navigate(href); setShowUserMenu(false); }}
                              ...
                              onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "rgba(124,111,255,0.1)"; }}
                        ...
                        <div style={{ margin: "0 12px 10px" }}>
                          <button
                            ...
                            style={{
                              ...
                              background: isMegaFan
                                ? "linear-gradient(135deg,rgba(124,111,255,0.2),rgba(245,158,11,0.1))"
                                : "linear-gradient(135deg,rgba(124,111,255,0.15),rgba(79,70,229,0.08))",
                              border: isMegaFan ? "1px solid rgba(245,158,11,0.4)" : "1px solid rgba(124,111,255,0.35)",
                          ...
                          >
                            <div style={{
                              ...
                              background: isMegaFan ? "linear-gradient(135deg,#F59E0B,#D97706)" : "linear-gradient(135deg,#7C6FFF,#5B52F5)",
                              display: "flex", alignItems: "center", justifyContent: "center",
                              boxShadow: isMegaFan ? "0 4px 12px rgba(245,158,11,0.4)" : "0 4px 12px rgba(124,111,255,0.4)",
                            }}>
                              {isMegaFan ? <Crown size={16} color="#fff" /> : <Zap size={16} color="#fff" />}
                            </div>
                            <div style={{ flex: 1, textAlign: "left" }}>
                              <div style={{ color: isMegaFan ? "#FCD34D" : "#B39DFF", fontSize: 12, fontWeight: 800 }}>
                        ...
                        <div style={{ margin: "0 12px", borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 6 }}>
                          {[
                            ...(isOwner ? [{ icon: <LayoutDashboard size={13} />, label: "Panel de Admin", href: "/admin", color: "#B39DFF" }] : []),
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 10, background: "linear-gradient(135deg,#7C6FFF,#5B52F5)",
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
              <Link href="/" onClick={() => setMobileMenuOpen(false)} style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
                <div style={{ width: 28, height: 28, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg,#7C6FFF,#5B52F5)" }}>
              ...
              {mobileNavItems.map(({ label, icon, href }) => (
                <button
                  ...
                  style={{
                    ...
                    background: isActive(href) ? "rgba(124,111,255,0.15)" : "transparent",
                    color: isActive(href) ? "#B39DFF" : "rgba(255,255,255,0.75)",
                    fontSize: 15, fontWeight: 600,
                    borderLeft: isActive(href) ? "3px solid #7C6FFF" : "3px solid transparent",
                  }}
                >
                  {icon} {label}
                </button>
            ...
            <div style={{ padding: "12px 12px" }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: 12, border: "1px solid rgba(124,111,255,0.3)", cursor: "pointer",
                  background: "rgba(124,111,255,0.1)", color: "#B39DFF", fontSize: 15, fontWeight: 600,
                }}
              >
            ...
            <div style={{ padding: "12px 12px", marginTop: "auto" }}>
              {user ? (
                <>
                  <div style={{ background: "rgba(124,111,255,0.08)", borderRadius: 12, marginBottom: 8, overflow: "hidden" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px" }}>
                      <div style={{ width: 40, height: 40, borderRadius: 10, background: "linear-gradient(135deg,#7C6FFF,#5B52F5)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                        {resolveAvatarUrl(user.avatar_url)
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: "none", color: isMegaFan ? "#B39DFF" : "rgba(255,255,255,0.55)", fontSize: 13, fontWeight: 600,
                      }}
                    >
                      <Crown size={15} color={isMegaFan ? "#B39DFF" : undefined} />
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 12, border: "none", cursor: "pointer",
                    background: "linear-gradient(135deg,#7C6FFF,#5B52F5)", color: "#fff", fontSize: 15, fontWeight: 800,
                  }}
                >
    ...
    <Link href={href} style={{ textDecoration: "none" }}>
      <div
        style={{
          ...
          color: active ? "#B39DFF" : "rgba(255,255,255,0.55)",
          background: active ? "rgba(124,111,255,0.12)" : "none",

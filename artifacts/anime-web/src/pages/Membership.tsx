    ...
    <>
      ...
      <div style={{ minHeight: "100vh", background: "#07071a", color: "#fff", paddingBottom: 80 }}>
        ...
        <div style={{ position: "relative", overflow: "hidden", padding: "72px 16px 56px", textAlign: "center" }}>
          <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(124,111,255,0.18) 0%, transparent 70%)", pointerEvents: "none" }} />
          <div style={{ position: "absolute", top: -60, left: "50%", transform: "translateX(-50%)", width: 500, height: 500, borderRadius: "50%", background: "radial-gradient(circle, rgba(124,111,255,0.07) 0%, transparent 70%)", pointerEvents: "none" }} />

          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(124,111,255,0.15)", border: "1px solid rgba(124,111,255,0.3)", borderRadius: 100, padding: "6px 16px", marginBottom: 20 }}>
            <span style={{ fontSize: 12 }}>👑</span>
            <span style={{ fontSize: 12, fontWeight: 700, color: "#B39DFF", letterSpacing: 1 }}>PLAN PREMIUM</span>
          </div>
          ...
          <h1 style={{ fontSize: "clamp(28px,6vw,48px)", fontWeight: 900, margin: "0 0 12px", lineHeight: 1.15 }}>
            ...
            <span style={{ background: "linear-gradient(135deg,#B39DFF,#7C6FFF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>con MegaFan</span>
          </h1>
              ...
              {(["monthly","annual"] as Plan[]).map(p => (
                <button
                  ...
                  style={{
                    ...
                    transition: "all 0.2s",
                    background: plan === p ? "linear-gradient(135deg,#7C6FFF,#5B52F5)" : "transparent",
        ...
        <div style={{ maxWidth: 480, margin: "0 auto", padding: "0 16px 48px" }}>
          <div style={{
            ...
            borderRadius: 24,
            overflow: "hidden",
            boxShadow: "0 0 0 1px rgba(124,111,255,0.1), 0 32px 80px rgba(124,111,255,0.2), 0 8px 32px rgba(0,0,0,0.6)",
          }}>
            {/* Glow top */}
            <div style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: "100%", height: 2, background: "linear-gradient(90deg,transparent,rgba(124,111,255,0.8),transparent)" }} />
            <div style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: "60%", height: 60, background: "radial-gradient(ellipse, rgba(124,111,255,0.15) 0%, transparent 70%)", pointerEvents: "none" }} />
            ...
            <div style={{ padding: "32px 28px 28px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 24 }}>
                <div style={{ width: 40, height: 40, borderRadius: 12, background: "linear-gradient(135deg,rgba(124,111,255,0.3),rgba(79,70,229,0.2))", border: "1px solid rgba(124,111,255,0.4)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}>
                  👑
                </div>
                <div>
              ...
              {/* Divider */}
              <div style={{ height: 1, background: "linear-gradient(90deg,transparent,rgba(124,111,255,0.2),transparent)", marginBottom: 22 }} />
                ...
                {FEATURES.map(f => (
                  <div key={f.label} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    <div style={{
                      ...
                      background: f.free ? "rgba(255,255,255,0.04)" : "rgba(124,111,255,0.15)",
                      border: `1px solid ${f.free ? "rgba(255,255,255,0.06)" : "rgba(124,111,255,0.25)"}`,
                      ...
                      {f.free ? (
                        ...
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                          <path d="M2 6l3 3 5-5" stroke="#B39DFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      )}
                    </div>
                    ...
                    {!f.free && (
                      <span style={{ marginLeft: "auto", fontSize: 11, background: "rgba(124,111,255,0.15)", color: "#B39DFF", padding: "2px 7px", borderRadius: 6, fontWeight: 700, whiteSpace: "nowrap" }}>
                        MegaFan
                      </span>
                    )}
                  </div>
              ...
              {!user ? (
                ...
                <div>
                  <div style={{ background: "linear-gradient(135deg,rgba(124,111,255,0.15),rgba(79,70,229,0.08))", border: "1px solid rgba(124,111,255,0.3)", borderRadius: 14, padding: "18px 20px", textAlign: "center", marginBottom: 14 }}>
                    <div style={{ fontSize: 24, marginBottom: 6 }}>👑</div>
                    <p style={{ color: "#B39DFF", fontWeight: 800, fontSize: 15, margin: "0 0 4px" }}>¡Ya eres MegaFan!</p>
                    <p style={{ color: "rgba(255,255,255,0.35)", fontSize: 12, margin: 0 }}>Gracias por apoyar AnimeFlex</p>
                  </div>
                  <button
                    onClick={handleManage}
                    disabled={loading}
                    style={{ width: "100%", padding: "13px 0", borderRadius: 12, border: "1px solid rgba(124,111,255,0.4)", background: "transparent", color: "#B39DFF", fontSize: 14, fontWeight: 700, cursor: "pointer" }}
                  >
                ...
                <div>
                  {loading && (
                    <div style={{ textAlign: "center", padding: "14px 0", color: "rgba(255,255,255,0.4)", fontSize: 14, display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
                      <span style={{ display: "inline-block", width: 14, height: 14, border: "2px solid #7C6FFF", borderTopColor: "transparent", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
                      Procesando pago...
                    </div>
                  )}
        ...
        <div style={{ maxWidth: 700, margin: "0 auto 60px", padding: "0 16px" }}>
          <h2 style={{ textAlign: "center", fontSize: 20, fontWeight: 800, color: "#F1F1F5", marginBottom: 24 }}>
            ¿Por qué elegir <span style={{ color: "#B39DFF" }}>MegaFan</span>?
          </h2>
        ...
        <div style={{ maxWidth: 560, margin: "0 auto 60px", padding: "0 16px" }}>
          <h2 style={{ textAlign: "center", fontSize: 20, fontWeight: 800, color: "#F1F1F5", marginBottom: 24 }}>
            Gratis vs <span style={{ color: "#B39DFF" }}>MegaFan</span>
          </h2>
          <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 20, overflow: "hidden" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 100px 100px", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
              ...
              <div style={{ padding: "12px 8px", textAlign: "center", fontSize: 12, fontWeight: 700, color: "#B39DFF", background: "rgba(124,111,255,0.08)" }}>MEGAFAN 👑</div>
            </div>
            {[
              ...
              <div key={row.label} style={{ display: "grid", gridTemplateColumns: "1fr 100px 100px", borderBottom: i < arr.length - 1 ? "1px solid rgba(255,255,255,0.05)" : "none" }}>
                ...
                <div style={{ padding: "13px 8px", textAlign: "center", background: "rgba(124,111,255,0.05)" }}>
                  {row.pro ? <span style={{ color: "#B39DFF", fontSize: 14, fontWeight: 700 }}>✓</span> : <span style={{ color: "rgba(255,255,255,0.12)", fontSize: 14 }}>—</span>}
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: 560, margin: "0 auto 60px", padding: "0 16px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {FAQS.map((faq, i) => (
              <div key={i} style={{ background: "rgba(255,255,255,0.03)", border: `1px solid ${openFaq === i ? "rgba(124,111,255,0.3)" : "rgba(255,255,255,0.07)"}`, borderRadius: 14, overflow: "hidden", transition: "border 0.2s" }}>
                <button
                    ...
                    <tbody>
                      {payments.map((p, i) => (
                        <tr key={p.order_id} style={{ borderBottom: i < payments.length - 1 ? "1px solid rgba(255,255,255,0.05)" : "none" }}>
                          ...
                          <td style={{ padding: "11px 16px", color: "#B39DFF", fontWeight: 700, textTransform: "capitalize" }}>{p.plan}</td>

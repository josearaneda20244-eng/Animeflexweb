...
export default function NotFound() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Body silhouette */}
        <ellipse cx="90" cy="180" rx="40" ry="12" fill="rgba(220,38,38,0.15)" />
        {/* Legs */}
        ...
        <text x="31" y="101" fontSize="12" fill="#FECACA" fontWeight="900">?</text>
        {/* Neck */}
        <rect x="83" y="58" width="14" height="16" rx="7" fill="#2A2A4A" />
        {/* Head */}
        <ellipse cx="90" cy="44" rx="30" ry="34" fill="#2A2A4A" />
        {/* Hair */}
        <path d="M60 30 Q60 5 90 8 Q120 5 120 30 Q115 20 90 22 Q65 20 60 30Z" fill="#DC2626" />
        <path d="M60 30 Q52 40 55 55 Q60 48 65 50 Z" fill="#DC2626" />
        <path d="M120 30 Q128 40 125 55 Q120 48 115 50 Z" fill="#DC2626" />
        {/* Eyes — swirly X eyes */}
        ...
        <text x="28" y="60" fontSize="10" fill="#FECACA" opacity="0.5">✦</text>
        <text x="150" y="90" fontSize="8" fill="#DC2626" opacity="0.5">✦</text>
      </svg>
      ...
      <div
        style={{
          ...
          lineHeight: 1,
          letterSpacing: -4,
          background: "linear-gradient(135deg, #DC2626 0%, #FECACA 50%, #DC2626 100%)",

              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${isActive ? "#DC2626" : "rgba(255,255,255,0.1)"}`,
                    background: isActive ? "rgba(220,38,38,0.2)" : "rgba(255,255,255,0.04)",
                    color: isActive ? "#FECACA" : "rgba(255,255,255,0.55)",
                    cursor: "pointer", position: "relative",
                  }}
                >
                  <span style={{ fontSize: 13, fontWeight: 800 }}>{d}</span>
                  <span style={{ fontSize: 10, color: isActive ? "#FECACA" : "rgba(255,255,255,0.35)" }}>{count} ep</span>
                  {isToday && (
                    <span style={{
                  ...
                  >
                    ...
                    <button
                      style={{
                        ...
                        background: isPast ? "#DC2626" : "rgba(255,255,255,0.07)",

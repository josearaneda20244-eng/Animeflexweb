  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 14px 32px rgba(108,99,255,0.35)";
    ...
    >
      ...
      <div style={{ position: "absolute", top: 8, left: 8, display: "flex", gap: 4 }}>
        <span style={{ background: "#6C63FF", borderRadius: 4, padding: "2px 6px", color: "#fff", fontSize: 8, fontWeight: 900 }}>MOVIE</span>
      ...
      <div className="hover-overlay" style={{
        ...
        <div style={{ width: 48, height: 48, borderRadius: "50%", background: "#6C63FF", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <Play size={20} color="#fff" fill="#fff" />
        </div>
        {anime.genres && anime.genres.length > 0 && (
          <div style={{ display: "flex", flexWrap: "wrap", gap: 4, justifyContent: "center", padding: "0 12px" }}>
            {anime.genres.slice(0, 3).map((g) => (
              <span key={g} style={{ background: "rgba(108,99,255,0.3)", border: "1px solid rgba(108,99,255,0.5)", borderRadius: 6, padding: "2px 6px", color: "#A78BFA", fontSize: 9, fontWeight: 700 }}>{g}</span>
            ))}
          </div>
        )}
      </div>
        ...
        <div style={{ padding: "32px 16px 20px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ width: 4, height: 32, borderRadius: 2, background: "#6C63FF" }} />
              <div>
            ...
            <button
              ...
              style={{ display: "flex", alignItems: "center", gap: 7, padding: "10px 16px", borderRadius: 12, background: "rgba(108,99,255,0.15)", border: "1px solid rgba(108,99,255,0.35)", color: "#A78BFA", fontSize: 13, fontWeight: 700, cursor: "pointer" }}
            >
          ...
          {!isLoading && uniqueMovies.length === 0 && (
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 80, gap: 12 }}>
              ...
              <button
                ...
                style={{ marginTop: 8, padding: "10px 24px", borderRadius: 12, background: "#6C63FF", border: "none", color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer" }}
              >
                Buscar Películas
              </button>
            </div>

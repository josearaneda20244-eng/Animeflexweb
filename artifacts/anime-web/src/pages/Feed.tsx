  ...
  return (
    <div style={{ minHeight: "100vh", background: "#07080F" }}>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "72px 16px 48px" }}>
        ...
        {!token ? (
          <div style={{ background: "#0F0F1A", borderRadius: 20, padding: "48px 24px", textAlign: "center", border: "1px solid rgba(255,255,255,0.07)" }}>
            ...
            {activities.map((a, i) => {
              ...
              return (
                <div key={`${a.user_id}-${a.anime_id}-${i}`}
                  style={{ background: "#0F0F1A", borderRadius: 14, padding: 14, border: "1px solid rgba(255,255,255,0.06)", display: "flex", gap: 12, alignItems: "center", cursor: "pointer" }}
